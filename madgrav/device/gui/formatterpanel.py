...
from madgrav.core.elements.element_types import (
    effect_nodes,
    elem_group_nodes,
    elem_nodes,
    op_nodes,
...
class FormatterPanel(wx.Panel):
    ...
    **End-User Perspective:**
    This panel provides user interface controls for formatter functionality in MadGrav."""
    ...
    def __init__(self, *args, context=None, **kwds):
        ...
        if hasattr(top, "add_module_delegate"):
            top.add_module_delegate(patternpanel)
