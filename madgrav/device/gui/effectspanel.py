...
from madgrav.core.units import Angle
from madgrav.device.devicechoices import get_effect_choices

# from madgrav.core.elements.element_types import elem_group_nodes, op_nodes
...
from madgrav.gui.wxutils import dip_size
...
class EffectsPanel(wx.Panel):
    ...
    **End-User Perspective:**
    This panel provides user interface controls for effects functionality in MadGrav."""
    ...
    def __init__(self, *args, context=None, **kwds):
        ...
        if hasattr(top, "add_module_delegate"):
            top.add_module_delegate(epanel)
    ...
    def get_node_patterns(self, nodetype):
        ...
        from madgrav.core.node.bootstrap import bootstrap
