...
from madgrav.balormk.driver import BalorDriver
from madgrav.core.spoolers import Spooler
from madgrav.core.units import Angle, Length
from madgrav.core.view import View
from madgrav.device.devicechoices import get_effect_choices, get_operation_choices
from madgrav.device.mixins import Status
from madgrav.kernel import Service, signal_listener


class BalorDevice(Service, Status):
    """
    The BalorDevice is a MadGrav service for the device type. It should be the main method of interacting with
    the rest of madgrav. It defines how the scene should look and contains a spooler which madgrav will give jobs
