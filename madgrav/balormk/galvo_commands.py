...
def plugin(service, lifecycle):
    ...
    def galvo_save(channel, _, filename, data=None, **kwargs):
        ...
        try:
            with open(filename, "w") as f:
                ...
                from madgrav.balormk.controller import list_command_lookup
    ...
    def galvo_raw(
        ...
        **kwgs,
        ...
        """
        from madgrav.balormk.controller import (
            list_command_lookup,
    ...
    def codes_update(channel, filename, **kwargs):
        ...
        from madgrav.balormk.clone_loader import load_sys
        ...
        if service.clone_sys == "chunks":
            from madgrav.balormk.clone_loader import load_chunks
        ...
        # Check for file in the madgrav directory (safe_path)
