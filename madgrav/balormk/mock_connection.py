...
class MockConnection:
    ...
    def write(self, index=0, packet=None):
        from madgrav.balormk.controller import GetSerialNo, ReadPort
        ...
        if packet is not None:
            ...
            b = packet[0]
            if b == GetSerialNo:
                self.set_implied_response("madgrav")
            elif b == ReadPort:
    ...
    def _parse_single(self, packet):
        from madgrav.balormk.controller import single_command_lookup
