...
class BalorConfiguration(MWindow):
    ...
    **End-User Perspective:**
    This panel provides user interface controls for balorconfiguration functionality in MadGrav."""
    ...
    def __init__(self, *args, **kwds):
        ...
        # newpanel = EffectsPanel(self.notebook_main, id=wx.ID_ANY, context=self.context)
        # self.panels.append(newpanel)
    ...
    def on_corfile_changed(self, origin, *args):
        from madgrav.balormk.controller import GalvoController
