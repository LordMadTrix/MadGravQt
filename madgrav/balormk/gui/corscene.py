...
from madgrav.gui.icons import icons8_detective
from madgrav.gui.laserrender import LaserRender
from madgrav.gui.wxutils import get_gc_scale
from madgrav.gui.scene.sceneconst import HITCHAIN_HIT, RESPONSE_CHAIN, RESPONSE_CONSUME
...
class CorFileWidget(Widget):
    ...
    def corfile_outline(self):
        ...
        if self.job:
            ...
            self.job = None
            return
        from madgrav.balormk.livelightjob import LiveLightJob
