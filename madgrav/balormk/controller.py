...
from madgrav.balormk.mock_connection import MockConnection
from madgrav.balormk.usb_connection import USBConnection
            ...
            try:
                ...
                if count >= 10:
                    ...
                    if osname == "Windows":
                        ...
                        self.usb_log(
                            "Consult the wiki: https://github.com/madgrav/madgrav/wiki/Install%3A-Windows"
                        )
                    raise ConnectionRefusedError(
