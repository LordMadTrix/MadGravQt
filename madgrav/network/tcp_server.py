...
class TCPServer(Module):
    ...
    def __init__(self, context, name, port=23, address=""):
        """
        Laser Server init.
        ...
        @param address: Interface to bind to. "" (default, kept for the
            hardware-facing servers like the GRBL/Ruida bridges) binds all
            interfaces; pass "127.0.0.1" to restrict to local connections
            only, which callers that expose raw command execution should do.
        """
