...
from madgrav.gui.icons import STD_ICON_SIZE, icon_kerf, icons8_detective
...
from madgrav.svgelements import Color, Matrix, Polyline
    ...
    **End-User Perspective:**
    ...
    def on_button_generate(self, event):
        ...
        def create_slider():
            ...
            cut_op = CutOpNode(label="Regular cut (no kerf)")
            cut_op.color = Color("red")
            cut_op.speed = op_speed
            cut_op.power = op_power
            cut_op.kerf = 0
            engrave_op = EngraveOpNode(label="Markings")
