...
Ruida classes deal with interactions between MadGrav and Ruida-devices connected
...
- **Bridge Interface**: Translates between Ruida protocol and MadGrav's internal cutcode
...
- **Coordinate Mapping**: Translates between Ruida and MadGrav coordinate systems
...
- **Device Integration**: Routes commands to active MadGrav laser devices

### Device Layer (`device.py`)
- **Service Integration**: Registers as MadGrav device service
...
- **Cutcode Translation**: Converts Ruida commands to MadGrav cutcode
- **Plot Planning**: Integrates with MadGrav's plot planning system
...
annoying at times causing one to reconfigure a connection in MadGrav in order
...
- **MadGrav Units**: Internal micron-based coordinate system
...
- `RuidaDevice`: MadGrav device service integration
...
# Test file loading
python -c "from madgrav.ruida.loader import RDLoader; print('RD loader available')"
```

### Dependencies
- MadGrav core libraries
