...
from madgrav.core.units import UNITS_PER_uM
...
class RDJob:
    ...
    def process(self, array, offset=None):
        ...
        if array[0] < 0x80:
            ...
            # NOTE: dead branch, 0x0C already matched above -- likely a
            # transcription slip in this opcode table. Left as-is rather
            # than guessing the intended byte; only the log description is
            # affected, no state changes happen in either branch.
            elif array[1] == 0x0C:
                v1 = array[2]
            ...
            # NOTE: dead branch, 0x32 already matched above -- same
            # transcription-slip situation as the 0x0C case, see above.
            elif array[1] == 0x32:
