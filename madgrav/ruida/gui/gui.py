def plugin(service, lifecycle):
    ...
    if lifecycle == "added":
        ...
        from madgrav.ruida.gui.ruidaconfig import RuidaConfiguration
        from madgrav.ruida.gui.ruidacontroller import RuidaController
        # from madgrav.ruida.gui.ruidaoperationproperties import RuidaOperationPanel
