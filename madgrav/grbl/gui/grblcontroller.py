...
from madgrav.gui.wxutils import TextCtrl, dip_size, wxButton, wxStaticText
...
class GRBLControllerPanel(wx.Panel):
    ...
    **Technical Purpose:**
    ...
    MadGrav kernel's signal system to maintain synchronized device state and user interface updates.
