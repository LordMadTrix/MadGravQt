def plugin(service, lifecycle):
    ...
    if lifecycle == "added":
        from madgrav.grbl.gui.grblconfiguration import GRBLConfiguration
        from madgrav.grbl.gui.grblcontroller import GRBLController
        from madgrav.grbl.gui.grblhardwareconfig import GRBLHardwareConfig
        from madgrav.grbl.gui.grbloperationconfig import GRBLAdvancedPanel
        from madgrav.grbl.gui.esp3dfilemgr import register_panel_esp3d_files
        ...
        from madgrav.grbl.gui.esp3dupload import run_esp3d_upload_with_prompt
