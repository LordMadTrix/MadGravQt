...
"""
from madgrav.grbl.control import GRBLControl, greet
from madgrav.grbl.device import GRBLDevice, GRBLDriver
from madgrav.grbl.emulator import GRBLEmulator
from madgrav.grbl.gcodejob import GcodeJob
from madgrav.grbl.interpreter import GRBLInterpreter
from madgrav.grbl.loader import GCodeLoader
    ...
    if lifecycle == "plugins":
        ...
        def init_esp3d_commands(kernel):
            ...
            def esp3d_upload_run(command, channel, _, data=None, filename=None, execute=False, **kwargs):
                ...
                temp_fd, temp_path = tempfile.mkstemp(suffix=".gc", prefix="madgrav_esp3d_")
