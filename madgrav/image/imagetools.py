...
from madgrav.constants import RASTER_B2T, RASTER_T2B
...
from madgrav.core.units import DEFAULT_PPI, UNITS_PER_PIXEL, Angle
...
def plugin(kernel, lifecycle=None):
    ...
    def image_linecut(command, channel, _, data, x1, y1, x2, y2, **kwargs):
        ...
        for inode in data:
            ...
            from madgrav.extra.imageactions import create_image, mask_image
