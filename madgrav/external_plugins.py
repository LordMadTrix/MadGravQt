...
MADGRAV_ENTRYPOINT = "madgrav.extension"
...
def plugins_pre_38():
    ...
    for entry_point in pkg_resources.iter_entry_points(MADGRAV_ENTRYPOINT):
        try:
...
def plugins_importlib():
    ...
    try:
        ep = entry_points.select(group=MADGRAV_ENTRYPOINT)
    except AttributeError:
        ep = entry_points.get(MADGRAV_ENTRYPOINT)
