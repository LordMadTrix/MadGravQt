...
parser.add_argument("-V", "--version", action="store_true", help="MadGrav version")
...
parser.add_argument(
    "-Q", "--qt", action="store_true", help="use PyQt6 modern UI"
)
parser.add_argument(
...
parser.add_argument(
    ...
    "--no-plugins",
    action="store_true",
    help="Do not load madgrav.plugins entrypoints",
)
parser.add_argument(
    "-A",
    "--disable-ansi",
...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="run madgrav with profiler file specified",
)
parser.add_argument(
    "-u",
    "--lock-device-config",
...
parser.add_argument(
    "-d", "--daemon", action="store_true", help="keep MadGrav in background"
)
...
def _exe(restarted, args):
    ...
    from madgrav.external_plugins import plugin as external_plugins
    from madgrav.internal_plugins import plugin as internal_plugins
