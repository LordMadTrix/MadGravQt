...
from madgrav.core.units import UNITS_PER_MM, UNITS_PER_PIXEL
from madgrav.kernel import lookup_listener, signal_listener
from madgrav.rotary.rotary_cam import (
    bed_height_mm,
    bed_length_mm,
...
def _repair_text_matrix(node, renderer=None):
    """
    MadGrav text uses translate(x,y) + scale(UNITS_PER_PIXEL) on the matrix.
