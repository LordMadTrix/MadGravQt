...
def plugin(kernel, lifecycle):
    ...
    if lifecycle == "register":
        from madgrav.camera.gui.camerapanel import (
            CameraInterface,
            register_panel_camera,
        )

        from madgrav.camera.gui.align_wizard import CameraAlignWizard
        from madgrav.camera.gui.cameracal import CameraCalibWindow

        kernel.register("window/CameraInterface", CameraInterface)
        kernel.register("window/CameraCalib", CameraCalibWindow)
        kernel.register("window/CameraAlignWizard", CameraAlignWizard)
