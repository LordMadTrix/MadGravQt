...
class MoshiDriverGui(MWindow):
    ...
    **End-User Perspective:**
    This panel provides user interface controls for moshidrivergui functionality in MadGrav."""
    ...
    def __init__(self, *args, **kwds):
        ...
        panel_effects = ChoicePropertyPanel(
            self.notebook_main, id=wx.ID_ANY, context=self.context, choices="moshi-effects"
        )
        panel_defaults = ChoicePropertyPanel(
            self.notebook_main, id=wx.ID_ANY, context=self.context, choices="moshi-defaults"
        )
