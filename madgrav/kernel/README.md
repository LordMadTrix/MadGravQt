...
The Kernel is the central nervous system of MadGrav, providing a sophisticated plugin architecture, service management, and communication infrastructure. It serves as the foundation that enables modular development and extensibility across the entire application.
...
This Kernel architecture provides the foundation for MadGrav's modular, extensible design, enabling complex laser control systems to be built from composable, reusable components.