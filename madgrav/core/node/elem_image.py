...
from madgrav.core.node.mixins import LabelDisplay, Suppressable
from madgrav.core.node.node import Node
from madgrav.core.units import UNITS_PER_INCH, UNITS_PER_MM
from madgrav.image.imagetools import RasterScripts
from madgrav.svgelements import Matrix, Path, Polygon
...
class ImageNode(Node, LabelDisplay, Suppressable):
    ...
    def _apply_dither(self, image):
        ...
        """
        from madgrav.image.imagetools import dither
