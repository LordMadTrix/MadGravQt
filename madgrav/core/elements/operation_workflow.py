"""
Operation Workflow Management System for MadGrav
...
class OperationWorkflow:
    """
    Main workflow orchestrator that analyzes MadGrav operations and creates
    ...
    def add_operation(self, operation_node, operation_type: str):
        ...
        Args:
            operation_node: The operation node from MadGrav tree
