...
from madgrav.core.undos import Undo
from madgrav.core.units import Length
from madgrav.core.wordlist import Wordlist
from madgrav.kernel import ConsoleFunction, Service, Settings
from madgrav.svgelements import Color, Path, Point, SVGElement
    ...
    if lifecycle == "plugins":
        ...
        choices = [
            ...
            },
            {
                ...
                "tip": _("How many undo-levels shall MadGrav hold in memory"),
                "page": "Start",
                # Hint for translation _("Undo")
                "section": "_60_Undo",
            ...
            },
            {
                ...
                + "\n"
                + _("then MadGrav can create a matching operation for you."),
                "page": "Classification",
                # Hint for translation _("Auto-Generation")
                "section": "_90_Auto-Generation",
            },
                ...
                for op in operations:
                    ...
                    if (
                        ...
                        if classified:
                            ...
                            if debug:
                                sstroke = (
                                    f"s={getattr(node, 'stroke')}," if hasattr(node, "stroke") else ""
                                )
                                sfill = (
                                    f"s={getattr(node, 'fill')}," if hasattr(node, "fill") else ""
                                )
                                debug(
