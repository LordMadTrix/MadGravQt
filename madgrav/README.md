...
This ReadMe page describes how the Madgrav python code is structured and provides a very brief description of each of
the major subdirectories.

## Kernel

The Kernel serves as the central code that binds modules together within Madgrav.
...
Whilst the kernel has been written initially for Madgrav, there is no reason why it should not be used as the core
...
Core modules are largely tools and classes that define Madgrav specific ecosystem requirements within the kernel.
...
The main file handles the command line interface for Madgrav as well as loading and processing of different plugins, both internal and external.

## svgelements

The svgelements file is a directly included version of the svgelements project
[https://github.com/madgrav/svgelements](https://github.com/madgrav/svgelements)
...
like `Angle`, `Length`, `Color`, `Point` and `Matrix` which are used throughout MadGrav.
...
Many of these are fundamental objects within MadGrav. 
