# MadGrav Cylinder Correction Module
...
- **Tabbed Interface**: Integrated into MadGrav's window management
...
#### GUI Not Updating
- **Signal Issues**: Restart MadGrav to refresh signal connections
...
## Integration with MadGrav Ecosystem
