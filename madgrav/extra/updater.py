"""
The code inside this module provides routines to look for newer versions of madgrav on GitHub
"""
import http.client
import json
import os
...
def plugin(kernel, lifecycle):
    if lifecycle == "register":
        if os.environ.get("MADGRAV_DISABLE_UPDATER"):
        ...
        choices = [
            ...
            },
            {
                ...
                "choices": (0, 1, 2),
                "tip": _("How often should MadGrav look for new versions"),
                "page": "Options",
                # Hint for translation _("Check for updates on startup")
                "section": "Check for updates on startup",
        ...
        GITHUB_LATEST = "https://api.github.com/repos/madgrav/madgrav/releases/latest"
        # https://docs.github.com/en/rest/reference/repos#list-releases
        GITHUB_RELEASES = (
            "https://api.github.com/repos/madgrav/madgrav/releases?perpage=100"
        )
        ...
        @kernel.console_command(
            "check_for_updates",
            help=_("Check whether a newer version of Madgrav is available"),
        )
            ...
            def update_check(
                ...
                def update_test(*args):
                    ...
                    if default_system == 2:
                        ...
                        # Linux:
                        asset_requirement = ("madgrav-Linux",)
                        system_type = "Linux"
                        is_source = False
                        ...
                        asset_requirement = (
                            "madgrav.dmg",
                            "madgrav-m1.dmg",
                            "MadGrav_PyInst_11.dmg",
                            "MadGrav_unsigned.dmg",
                        )
                        system_type = "Mac-OSX"
                        is_source = False
                    ...
                    try:
                        ...
                        from madgrav.gui.wxutils import dip_size, wxButton, wxStaticText, TextCtrl
