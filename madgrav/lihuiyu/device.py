...
import madgrav.constants as mkconst
from madgrav.core.laserjob import LaserJob
from madgrav.core.spoolers import Spooler
from madgrav.core.units import UNITS_PER_MIL, Length
...
from madgrav.kernel import CommandSyntaxError, Service, signal_listener
...
class LihuiyuDevice(Service, Status):
    ...
    def acceleration_overrun(self, is_raster, op_speed):
        """
        https://github.com/madgrav/madgrav/wiki/Tech:-Lhymicro-Control-Protocols
        Non - Raster:
        1: [0 - 25.4]
        2: (25.4 - 60]
        3: (60 - 127)
