...
class LihuiyuControllerPanel(ScrolledPanel):
    ...
    **End-User Perspective:**
    ...
    def __init__(self, *args, context=None, **kwds):
        ...
        self.button_autodetect = wxButton(self, wx.ID_ANY, _("Auto-Detect Laser"))
        ...
        self.Bind(wx.EVT_BUTTON, self.on_button_autodetect, self.button_autodetect)
    ...
    def __do_layout(self):
        ...
        sizer_usb_connect.Add(self.button_autodetect, 0, wx.EXPAND, 0)
    ...
    def on_button_autodetect(self, event=None):
        self.context("autodetect_laser\n")
