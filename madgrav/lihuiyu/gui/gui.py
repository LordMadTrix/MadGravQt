...
def plugin(service, lifecycle):
    ...
    if lifecycle == "added":
        ...
        from madgrav.lihuiyu.gui.lhyaccelgui import LihuiyuAccelerationChart
        from madgrav.lihuiyu.gui.lhycontrollergui import LihuiyuControllerGui
        from madgrav.lihuiyu.gui.lhydrivergui import LihuiyuDriverGui
        from madgrav.lihuiyu.gui.lhyoperationproperties import LhyAdvancedPanel
        from madgrav.lihuiyu.gui.tcpcontroller import TCPController
