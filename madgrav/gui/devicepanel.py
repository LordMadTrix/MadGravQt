...
from madgrav.gui.icons import icons8_manager
...
def register_panel(window, context):
    ...
    pane.control = panel
    pane.helptext = _("Manage and add devices to be used by MadGrav")
...
class DeviceManager(MWindow):
    ...
    @staticmethod
    def helptext():
        return _("Manage and add devices to be used by MadGrav")
