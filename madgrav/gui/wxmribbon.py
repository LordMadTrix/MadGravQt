"""
The WxmRibbon Bar is a core aspect of MadGrav's interaction. To allow fully dynamic buttons we use the ribbonbar
control widget built into madgrav.
...
added to as well as a unique name. This defines within the madgrav ecosystem a methodology of specifically creating
...
from madgrav.gui.ribbon import RibbonBarPanel
...
from madgrav.kernel import Settings, lookup_listener, signal_listener
...
class MKRibbonBarPanel(RibbonBarPanel):
    """MadGrav Ribbon Bar Panel - Dynamic toolbar system providing categorized command access

    **Technical Purpose:**
    Implements a fully dynamic ribbon interface that organizes MadGrav commands into categorized panels
    ...
    **User Interface:**
    ...
    def get_current_config(self):
        import madgrav.gui.icons as mkicons
...
class RibbonEditor(wx.Panel):
    ...
    **End-User Perspective:**
    ...
    def __init__(self, *args, context=None, **kwds):
        ...
        self._config = None
        # Populated from a real ribbon toolbar's config via
        # get_current_config()/get_default_config() below when one exists.
        # Under --qt there's no wx ribbon to configure (Qt has its own
        # toolbar), so this stays empty rather than None -- fill_button()
        # and friends sort/iterate/append to it unconditionally.
        ...
        choices = [v for v in getattr(self.context, "_ribbons", {})]
