...
class WordlistEditor(MWindow):
    ...
    **End-User Perspective:**
    ...
    def __init__(self, *args, **kwds):
        ...
        try:
            self.panel_editor = WordlistPanel(self.notebook_main, wx.ID_ANY, context=self.context)
        except Exception as e:
            import traceback

            traceback.print_exc()
            self.panel_editor = wx.Panel(self.notebook_main)
            st = wx.StaticText(
        ...
        try:
            ...
            traceback.print_exc()
            self.panel_import = wx.Panel(self.notebook_main)
            wx.StaticText(
        ...
        try:
            ...
            traceback.print_exc()
            self.panel_about = wx.Panel(self.notebook_main)
            wx.StaticText(
