...
from madgrav.kernel.kernel import signal_listener
...
class FontGlyphPicker(wx.Dialog):
    ...
    def load_font(self):
        ...
        from madgrav.extra.hershey import FontPath
    ...
    **End-User Perspective:**
    ...
    def __init__(self, *args, context=None, **kwds):
        ...
        self.text_info = TextCtrl(
            ...
            wx.ID_ANY,
            _(
                "MadGrav can use True-Type-Fonts, Hershey-Fonts or Autocad-86 shape fonts designed to be rendered purely with vectors.\n"
...
class HersheyFontManager(MWindow):
    ...
    @staticmethod
    def helptext():
        return _("Manage the fonts available to MadGrav")
