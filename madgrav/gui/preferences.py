...
class PreferencesLanguagePanel(wx.Panel):
    ...
    **End-User Perspective:**
    ...
    def __init__(self, *args, context=None, **kwds):
        ...
        from .wxmadgrav import supported_languages
...
class PreferencesSavingPanel(wx.Panel):
    ...
    **End-User Perspective:**
    ...
    def save_config_and_prevent_further_writing(self):
        ...
        wx.MessageBox(
            message=_(
                ...
                + "So please exit MadGrav as soon as possible."
            ),
            caption=_("Warning"),
    ...
    def on_button_import(self, event=None):
        ...
        message += (
            _(
                "This may make MadGrav unworkable if the file does not have the right format!"
            )
            + "\n"
        )
        ...
        dlg = wx.FileDialog(
            ...
            wildcard="Madgrav-Config-Files (*.cfg)|*.cfg|All files (*.*)|*.*",
...
class Preferences(MWindow):
    ...
    **End-User Perspective:**
    ...
    def __init__(self, *args, **kwds):
        ...
        self.panel_main = PreferencesMain(
        ...
        self.panel_ribbon = RibbonEditor(
            self.notebook_main, wx.ID_ANY, context=self.context
        )
        ...
        if self.context.developer_mode:
            panel_space = ChoicePropertyPanel(
                self.notebook_main, wx.ID_ANY, context=self.context, choices="space"
            )
    ...
    @staticmethod
    def helptext():
        return _("Configure MadGravs behaviour")
