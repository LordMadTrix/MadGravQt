...
class MagnetOptionPanel(wx.Panel):
    ...
    Technical Purpose:
    Provides configuration controls for magnet snapping behavior in the MadGrav scene.
...
class MagnetActionPanel(wx.Panel):
    ...
    in the MadGrav scene. Handles manual positioning of magnet lines, automatic generation
