...
from madgrav.core.spatial import shortest_distance, shortest_distance_chunked, _cKDTree  # noqa: E402

from madgrav.core.elements.element_types import elem_group_nodes, elem_nodes
from madgrav.core.units import Length
from madgrav.gui.laserrender import DRAW_MODE_SELECTION
from madgrav.gui.scene.scene import (
    HITCHAIN_DELEGATE,
    HITCHAIN_HIT,
    RESPONSE_CHAIN,
    RESPONSE_CONSUME,
)
from madgrav.gui.scene.sceneconst import HITCHAIN_HIT_AND_DELEGATE
...
from madgrav.svgelements import Point
