...
from .icons import icon_about, icon_madgrav
...
def get_header_text():
    return _(
        "MadGrav is a personal fork of MeerK40t, a free MIT Licensed\n"
        + "open source project for lasering on K40 Devices.\n\n"
        + "Participation in the original project is highly encouraged.\n"
        + "Past participation, and continuing participation is graciously thanked.\n"
        + "MeerK40t, on which this fork is based, is mostly the brainchild\n"
        + "of Tatarize, who sincerely hoped his contributions would be but\n"
...
def get_eulogy_text():
    return _(
        "MadGrav is a fork of MeerK40t, the result of an incredible piece of work by David Olsen aka Tatarize.\n"
        + "He created MeerK40t over 4 years allowing users across the world to get the best out of their K40 equipment (and additional lasertypes).\n\n"
        ...
        + "If you are interested to read more about MadGrav's development history then please refer to:\nhttps://github.com/madgrav/madgrav/wiki/History:-Major-Version-History,-Changes,-and-Reasons"
    )
...
class AboutPanel(wx.Panel):
    def __init__(self, *args, context=None, **kwds):
        ...
        self.bitmap_button_1 = wx.BitmapButton(
            self, wx.ID_ANY, icon_madgrav.GetBitmap(resize=150)
        )
        ...
        msg = f"v{version}"
        self.madgrav_about_version_text.SetLabelText(msg)

    def __set_properties(self):
        self.bitmap_button_1.SetSize(self.bitmap_button_1.GetBestSize())
        self.madgrav_about_version_text = wxStaticText(self, wx.ID_ANY, "MadGrav")
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        self.madgrav_about_version_text.SetFont(
            wx.Font(
                fontsize,
        ...
        vsizer_pic_iver.Add(self.madgrav_about_version_text, 0, 0, 0)
        hsizer_pic_info.Add(vsizer_pic_iver, 0, wx.EXPAND, 0)
        hsizer_pic_info.AddSpacer(5)
        self.madgrav_about_text_header = wxStaticText(
            self,
            wx.ID_ANY,
            get_header_text() + "\n" + get_header_text_2(),
        )

        self.madgrav_about_text_header.SetFont(
            wx.Font(
                fontsize,
                wx.FONTFAMILY_DEFAULT,
                wx.FONTSTYLE_NORMAL,
        ...
        hsizer_pic_info.Add(self.madgrav_about_text_header, 1, wx.EXPAND, 0)
        ...
        madgrav_about_text = wxStaticText(
            self,
            wx.ID_ANY,
            _("Thanks go out to...\n")
            ...
            + _(
                "* Translators who helped internationalise MadGrav for worldwide use.\n"
            )
            + _(
        ...
        vsizer_main.Add(madgrav_about_text, 4, wx.EXPAND, 0)
...
class DavidPanel(ScrolledPanel):
    ...
    def on_eulogy(self, event):
        import webbrowser
        url = "https://github.com/madgrav/madgrav/wiki/History:-Major-Version-History,-Changes,-and-Reasons"
...
class InformationPanel(ScrolledPanel):
    ...
    def __do_layout(self):
        ...
        sizer_mk = StaticBoxSizer(self, wx.ID_ANY, "MadGrav", wx.HORIZONTAL)
    ...
    def get_components(self):
        ...
        def get_barcode():
            entry = [
                ...
                "",
                "",
                "https://pypi.org/project/madgrav-barcodes/",
            ]
            has_barcodes = False
            try:
                ...
                has_barcodes = True
                info = get_package_version("madgrav-barcodes", mk)
                status = _("Present")
            except ImportError:
                info = "??"
                status = _("Missing")
...
class About(MWindow):
    def __init__(self, *args, **kwds):
        ...
        self.panel_about = AboutPanel(self.notebook_main, wx.ID_ANY, context=self.context)
        self.panel_david = DavidPanel(self.notebook_main, wx.ID_ANY, context=self.context)
        self.panel_info = InformationPanel(self.notebook_main, wx.ID_ANY, context=self.context)
        self.panel_component = ComponentPanel(self.notebook_main, wx.ID_ANY, context=self.context)
        ...
        self.notebook_main.AddPage(self.panel_component, _("MadGrav-Components"))
