...
See Discussion:
https://github.com/madgrav/madgrav/discussions/1944
"""
...
class SimpleUI(MWindow):
    ...
    def sub_register(kernel):
        ...
        # from madgrav.gui.wxmscene import MadGravScenePanel
        # kernel.register("simpleui/scene", MadGravScenePanel)
        from madgrav.gui.laserpanel import LaserPanel

        kernel.register("simpleui/laserpanel", (LaserPanel, None))

        kernel.register("simpleui/navigation", (JogMovePanel, None))

        from madgrav.gui.consolepanel import ConsolePanel
