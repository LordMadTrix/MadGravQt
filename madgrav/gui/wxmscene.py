...
from madgrav.core.elements.element_types import elem_nodes
from madgrav.core.node.elem_image import ImageNode
from madgrav.core.units import UNITS_PER_MM, UNITS_PER_PIXEL, Angle, Length
from madgrav.gui.icons import STD_ICON_SIZE, icon_madgrav, icons8_r_white, icons8_text
from madgrav.gui.laserrender import DRAW_MODE_BACKGROUND, DRAW_MODE_GUIDES, LaserRender
from madgrav.gui.mwindow import MWindow
from madgrav.gui.propertypanels.imageproperty import ContourPanel
from madgrav.gui.scene.scenepanel import ScenePanel
from madgrav.gui.wxutils import dispatch_to_main_thread

from madgrav.gui.scene.sceneconst import (
    LAYER_BACKGROUND,
    LAYER_LIVE,
    LAYER_TOOLS,
    LAYER_GENERIC_NODES,
...
# from madgrav.gui.scenewidgets.affinemover import AffineMover
from madgrav.gui.scenewidgets.attractionwidget import AttractionWidget
from madgrav.gui.scenewidgets.bedwidget import BedWidget
from madgrav.gui.scenewidgets.elementswidget import (
    ElementsWidget,
    SHOW_REGMARKS,
    SHOW_ELEMENTS_SELECTED,
    SHOW_ELEMENTS_NONSELECTED,
)
from madgrav.gui.scenewidgets.gridwidget import GridWidget
from madgrav.gui.scenewidgets.guidewidget import GuideWidget
from madgrav.gui.scenewidgets.laserpathwidget import LaserPathWidget
from madgrav.gui.scenewidgets.machineoriginwidget import MachineOriginWidget

# from madgrav.gui.scenewidgets.nodeselector import NodeSelector
from madgrav.gui.scenewidgets.rectselectwidget import RectSelectWidget
from madgrav.gui.scenewidgets.reticlewidget import ReticleWidget

# from madgrav.gui.scenewidgets.selectionwidget import SelectionWidget
from madgrav.gui.toolwidgets.toolcircle import CircleTool
from madgrav.gui.toolwidgets.toolcontainer import ToolContainer
from madgrav.gui.toolwidgets.tooldraw import DrawTool
from madgrav.gui.toolwidgets.toolellipse import EllipseTool
from madgrav.gui.toolwidgets.toolimagecut import ImageCutTool
from madgrav.gui.toolwidgets.toolline import LineTool
from madgrav.gui.toolwidgets.toollinetext import LineTextTool
from madgrav.gui.toolwidgets.toolmeasure import MeasureTool
from madgrav.gui.toolwidgets.toolnodeedit import EditTool
from madgrav.gui.toolwidgets.toolnodemove import NodeMoveTool
from madgrav.gui.toolwidgets.toolparameter import ParameterTool
from madgrav.gui.toolwidgets.toolplacement import PlacementTool
from madgrav.gui.toolwidgets.toolpoint import PointTool
from madgrav.gui.toolwidgets.toolpointmove import PointMoveTool
from madgrav.gui.toolwidgets.toolpolygon import PolygonTool
from madgrav.gui.toolwidgets.toolpolyline import PolylineTool
from madgrav.gui.toolwidgets.toolrect import RectTool
from madgrav.gui.toolwidgets.toolrelocate import RelocateTool
from madgrav.gui.toolwidgets.toolribbon import RibbonTool
from madgrav.gui.toolwidgets.tooltabedit import TabEditTool
from madgrav.gui.toolwidgets.tooltext import TextTool
from madgrav.gui.toolwidgets.toolvector import VectorTool
from madgrav.gui.utilitywidgets.checkboxwidget import CheckboxWidget
from madgrav.gui.utilitywidgets.cyclocycloidwidget import CyclocycloidWidget
from madgrav.gui.utilitywidgets.harmonograph import HarmonographWidget
from madgrav.gui.utilitywidgets.seekbarwidget import SeekbarWidget
from madgrav.gui.wxutils import get_key_name, is_navigation_key
from madgrav.kernel import CommandSyntaxError, signal_listener
from madgrav.svgelements import Color, Matrix
...
def register_panel_scene(window, context):
    ...
    # panel1 = MadGravScenePanel(window, wx.ID_ANY, context=context, index=1)
    # control.AddPage(panel1, "scene1")
    # panel2 = MadGravScenePanel(window, wx.ID_ANY, context=context, index=2)
    # control.AddPage(panel2, "scene2")

    control = MadGravScenePanel(window, wx.ID_ANY, context=context)
...
class MadGravScenePanel(wx.Panel):
    def __init__(self, *args, context=None, index=None, **kwargs):
        ...
        def send_developer_feature(remainder="", **kwgs):
            from .wxmadgrav import send_data_to_developers
    ...
    def on_background_signal(self, origin, background):
        from madgrav.camera.camera import frame_for_wx_bitmap, make_bed_bitmap_from_frame
        ...
        if background is None:
            ...
            try:
                ...
                bitmap = None
        from madgrav.camera.camera import _apply_bed_background_to_scene
...
class SceneWindow(MWindow):
    def __init__(self, *args, **kwds):
        ...
        self.panel = MadGravScenePanel(self, wx.ID_ANY, context=self.context)
        self.sizer.Add(self.panel, 1, wx.EXPAND, 0)
        self.add_module_delegate(self.panel)
        _icon = wx.NullIcon
        _icon.CopyFromBitmap(icon_madgrav.GetBitmap())
        self.SetIcon(_icon)
