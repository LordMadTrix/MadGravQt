...
from madgrav.core.geomstr import TYPE_ARC, TYPE_CUBIC, TYPE_LINE, TYPE_QUAD, Geomstr
...
B)  VectorIcons may come as well from the Icon8 library, in this case we have named
    ...
    MadGrav team, either by creating them from scratch or by vectorizing some other
    freely available images.
    You can add a VectorIcon by changing into madgrav source directory and issiuing

    python ./madgrav/gui/icons.py <fully qualified filename of a svg-file>
...
class VectorIcon:
    ...
    def prepare_bitmap(
        ...
        from madgrav.gui.zmatrix import ZMatrix
...
icon_madgrav = VectorIcon(
    fill=(
        # Outer ring
        "[0x111111]M 198,100 A 98,98 0 0 1 100,198 A 98,98 0 0 1 2,100 A 98,98 0 0 1 100,2 A 98,98 0 0 1 198,100 Z",
        # Inner disc
        "[0x1f3a5f]M 190,100 A 90,90 0 0 1 100,190 A 90,90 0 0 1 10,100 A 90,90 0 0 1 100,10 A 90,90 0 0 1 190,100 Z",
        # Bold M monogram
        "[white]M 55,145 L 55,60 L 73,60 L 100,108 L 127,60 L 145,60 L 145,145 Z",
        # Laser-beam spark
        "[0xff3b30]M 178,8 L 188,18 L 178,28 L 168,18 Z",
    ),
    stroke=(
        # Diagonal laser beam crossing the badge
        "[width=6,0xff3b30]M 15,175 L 178,18",
    ),
)

icon_madgrav_transparent = VectorIcon(
    fill=None,
    stroke=(
        "[width=4,0x808080]M 55,145 L 55,60 L 73,60 L 100,108 L 127,60 L 145,60 L 145,145 Z",
        "[width=4,0x808080]M 15,175 L 178,18",
    ),
)
