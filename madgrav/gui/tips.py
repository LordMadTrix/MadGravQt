    ...
    **End-User Perspective:**
    ...
    def __init__(self, *args, context=None, **kwds):
        ...
        self.checkbox_update.SetToolTip(
            _(
                "Look for new tips on MadGravs website.\n"
    ...
    def setup_tips(self):
        ...
        self.tips.append(
            (
                _(
                    "Do you want to get extended information about a feature in MadGrav?\n"
        ...
        self.tips.append(
            (
                _(
                    "MadGrav supports more than 'just' a K40 laser.\n"
        ...
        self.tips.append(
            (
                _(
                    "MadGrav has an extensive set of commands that allow a lot of scriptable actions.\nJust open the console window and type 'help'"
                ),
                "pane show console\nhelp",
        ...
        self.tips.append(
            (
                _(
                    ...
                    + "Just click on the 'Update'-button to load additional hints from MadGravs website.\n"
    ...
    def load_tips_from_github(self):
        ...
        content = ""
        url = "https://github.com/madgrav/madgrav/raw/main/locale/"
...
class Tips(MWindow):
    ...
    @staticmethod
    def helptext():
        return _("Display some tips and tricks how to best use MadGrav")
