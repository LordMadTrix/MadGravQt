...
from madgrav.gui.icons import EmptyIcon, icon_library
from madgrav.gui.laserrender import swizzlecolor
from madgrav.gui.wxutils import dip_size, wxStaticBitmap
from madgrav.core.elements.element_types import op_burnable_nodes
