...
from madgrav.gui.laserrender import DRAW_MODE_ICONS, LaserRender, swizzlecolor
...
class TreePanel(wx.Panel):
    ...
    **End-User Perspective:**
    This panel provides user interface controls for tree functionality in MadGrav."""
...
class ElementsTree(MWindow):
    ...
    **End-User Perspective:**
    This panel provides user interface controls for elementstree functionality in MadGrav."""
...
class ShadowTree:
    ...
    **End-User Perspective:**
    This panel provides user interface controls for shadowtree functionality in MadGrav."""
