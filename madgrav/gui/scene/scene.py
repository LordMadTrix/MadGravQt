...
from madgrav.gui.laserrender import (
    DRAW_MODE_ANIMATE,
    DRAW_MODE_FLIPXY,
    DRAW_MODE_INVERT,
    DRAW_MODE_REFRESH,
...
from madgrav.gui.scene.scenespacewidget import SceneSpaceWidget
from madgrav.gui.wxutils import get_matrix_scale
from madgrav.gui.zmatrix import ZMatrix
import numpy as np
from madgrav.core.spatial import _cKDTree
from madgrav.kernel import Job, Module, signal_listener
from madgrav.svgelements import Matrix, Point
from madgrav.core.geomstr import NON_GEOMETRY_TYPES, TYPE_END
...
class Scene(Module, Job):
    ...
    def _update_buffer_ui_thread(self):
        ...
        if not self._cache.background_valid:
            ...
            gc.Destroy()
            from madgrav.camera.camera import composite_bed_photo_on_device_dc
