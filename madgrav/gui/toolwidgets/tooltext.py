...
from madgrav.core.units import UNITS_PER_PIXEL
from madgrav.gui.scene.sceneconst import RESPONSE_CHAIN, RESPONSE_CONSUME

# from madgrav.gui.toolwidgets.textentry import TextEntry
from madgrav.gui.toolwidgets.toolwidget import ToolWidget
