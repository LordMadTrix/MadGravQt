...
from madgrav.core.units import ACCEPTED_ANGLE_UNITS, ACCEPTED_UNITS, Angle, Length
...
def create_choices_for_node(node, elements) -> List[dict]:
    ...
    """
    choices = []
    from madgrav.core.treeop import get_tree_operation_for_node
