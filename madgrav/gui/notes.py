...
class NotePanel(wx.Panel):
    ...
    **End-User Perspective:**
    This panel provides user interface controls for note functionality in MadGrav."""
...
class Notes(MWindow):
    ...
    **End-User Perspective:**
    This panel provides user interface controls for notes functionality in MadGrav."""
