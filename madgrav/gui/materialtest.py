...
from madgrav.core.elements.element_types import op_parent_nodes
...
from madgrav.core.units import UNITS_PER_PIXEL, Angle, Length
from madgrav.gui.icons import get_default_icon_size, icons8_detective
from madgrav.gui.laserpanel import queue_cutplan_to_spooler
...
from madgrav.kernel import Settings, lookup_listener, settings, signal_listener
...
class TemplatePanel(wx.Panel):
    ...
    **End-User Perspective:**
    ...
    def __init__(self, *args, context=None, storage=None, **kwds):
        ...
        infomsg += "\n" + _(
            "Madgrav simplifies this task to find out the optimal settings"
        )
        infomsg += " " + _(
