...
from madgrav.gui.icons import STD_ICON_SIZE, icons8_console
from madgrav.gui.mwindow import MWindow
from madgrav.gui.wxutils import TextCtrl, dispatch_to_main_thread
...
class ConsolePanel(wx.ScrolledWindow):
    ...
    **End-User Perspective:**
    This panel provides user interface controls for console functionality in MadGrav."""
