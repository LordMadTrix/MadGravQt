...
from madgrav.core.spatial import (
...
class TestNearestNeighbor(unittest.TestCase):
    ...
    def test_scipy_kdtree_equivalence(self):
        ...
        from madgrav.core.spatial import _cKDTree as original_cKDTree
        ...
        import madgrav.core.spatial
        madgrav.core.spatial._cKDTree = None
        try:
            r_chunk = shortest_distance_chunked(p1, p2, False)
            self.assertAlmostEqual(r_kd[0], r_chunk[0], places=9)
        finally:
            # Restore original KD-tree availability
            madgrav.core.spatial._cKDTree = original_cKDTree
