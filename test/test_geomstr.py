...
from madgrav.fill.patterns import set_diamond1, set_line
from madgrav.svgelements import Arc, CubicBezier, Line, Matrix, QuadraticBezier
from madgrav.core.geomstr import (
    TYPE_LINE,
    TYPE_POINT,
    BeamTable,
    Clip,
