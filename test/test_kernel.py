...
from madgrav.kernel import kernel_console_command, service_console_command
...
class TestKernel(unittest.TestCase):
    ...
    def test_tree_menu(self):
        ...
        from madgrav.core.treeop import tree_operations_for_node
    ...
    def test_external_plugins(self):
        ...
        kernel.args = Args()
        try:
            from madgrav.external_plugins import plugin
...
class TestGetSafePath(unittest.TestCase):
    def test_get_safe_path(self):
        ...
        from madgrav.kernel import get_safe_path
